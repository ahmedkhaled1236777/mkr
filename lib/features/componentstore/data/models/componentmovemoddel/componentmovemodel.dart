...
class Componentmovemoddel extends Equatable {
  final bool? success;
  ...
  factory Componentmovemoddel.fromJson(Map<String, dynamic> json) {
    return Componentmovemoddel(
